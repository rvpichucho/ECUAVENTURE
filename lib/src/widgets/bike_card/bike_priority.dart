...
class BikePriorityWidget extends StatefulWidget {
  BikePriorityWidget({Key? key, required this.priority, required this.uid})
      : super(key: key);
  final int? priority;
  String? uid;
  @override
  State<BikePriorityWidget> createState() => _BikePriorityWidgetState();
}

class _BikePriorityWidgetState extends State<BikePriorityWidget> {
  Bikes _data = Bikes();
  String _dataEstado = '';
